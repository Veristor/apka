...
const PSE_CONFIG = {
    ...
    timeout: 10000, // 10 seconds (dłużej dla VPN)
    retries: 3,
    rateLimit: {
        maxRequests: 100,
...
const UI_CONFIG = {
    ...
    refreshIntervals: {
        realTimeData: 60000,        // 1 minuta - KPIs, alerty
        chartsData: 300000,         // 5 minut - wykresy
        historicalData: 3600000,    // 1 godzina - dane historyczne
        riskCalculation: 900000     // 15 minut - kalkulacja ryzyka
    },
...
const FEATURE_FLAGS = {
    ...
    // Advanced features (włączane postupnie)
